...
class DiffGNNLayer(nn.Module):
    def __init__(self, input_dim, hidden_dim, output_dim, num_heads=1):
        ...
        self.linear4 = nn.Linear(896, output_dim * 2)   
        self.linear5 = nn.Linear(1, output_dim * 2)  
    ...
    def transform_tensor(sfle, matrix):
        ...
        if matrix.dim() != 2:
            raise ValueError("The input tensor must be two-dimensional")
